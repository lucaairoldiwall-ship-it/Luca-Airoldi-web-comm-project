...
BLOG_AUTHOR = "Luca"  # (translatable)
BLOG_TITLE = "The M.A.L.L.S."  # (translatable)
...
BLOG_EMAIL = "luca.airoldi3@studenti.unimi.it"
BLOG_DESCRIPTION = "HELLO ROCKERS! We are the italian Punk Band The M.A.L.L.S. We can't wait to see you around northern Italy"  # (translatable)
